...
namespace WhiteLagoon.Web.Controllers
{
    public class BookingController : Controller
    {
        ...
        public IActionResult BookingConfirmation(int bookingId)
        {
            ...
            if (bookingFromDb.Status == SD.StatusPending)
            {
                ...
                if(session.PaymentStatus == "paid")
                {
                    ...
                    _unitOfWork.Booking.UpdateStripePaymentID(bookingFromDb.Id, session.Id, 
        ...
        public IActionResult BookingDetails(int bookingId)
        {
            ...
            {
                var avaiableVillaNumber = AssignAvailableVillaNumberByVilla(bookingFromDb.VillaId);

                bookingFromDb.VillaNumbers = _unitOfWork.VillaNumber.GetAll(u => u.VillaId == bookingFromDb.VillaId
                && avaiableVillaNumber.Any(x => x == u.Villa_Number)).ToList();
            }
